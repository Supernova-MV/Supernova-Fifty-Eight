  ...
  function slideVideo(slide, data, index, callback) {
    ...
    injectAssets(this.settings.plyr.js, 'Plyr', function () {
      ...
      waitUntil(function () {
        ...
        _this.Supernova-Fifty-Eightze(slide);
      });
          ...
          slideImage(slide, slideConfig, this.index, function () {
            ...
            if (slideConfig.zoomable && img.naturalWidth > img.offsetWidth) {
              ...
              new ZoomImages(img, slide, function () {
                _this.instance.Supernova-Fifty-Eightze();
              });
            }
  ...
  var GlightboxInit = function () {
    ...
    return _createClass(GlightboxInit, [{
      ...
      value: function showSlide() {
        ...
        if (hasClass(slideNode, 'loaded')) {
          ...
          slide.instance.setContent(slideNode, function () {
            hide(_this2.loader);
            _this2.Supernova-Fifty-Eightze();
      ...
      value: function slideAnimateIn(slide, first) {
        ...
        setTimeout(function () {
          _this4.Supernova-Fifty-Eightze(slide);
        }, 100);
      ...
      value: function build() {
        ...
        this.events['Supernova-Fifty-Eightze'] = addEvent('Supernova-Fifty-Eightze', {
          onElement: window,
          withCallback: function withCallback() {
            _this7.Supernova-Fifty-Eightze();
          }
        });
        this.built = true;
      }
    }, {
      key: "Supernova-Fifty-Eightze",
      value: function Supernova-Fifty-Eightze() {
        var slide = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        ...
        var descriptionSupernova-Fifty-Eightze = false;
        if (description && (hasClass(description, 'description-bottom') || hasClass(description, 'description-top')) && !hasClass(description, 'gabsolute')) {
          descriptionSupernova-Fifty-Eightze = true;
        }
        if (image) {
          if (winWidth <= 768) {
            var imgNode = image.querySelector('img');
          } else if (descriptionSupernova-Fifty-Eightze) {
        ...
        if (video) {
          ...
          if (descriptionSupernova-Fifty-Eightze) {
