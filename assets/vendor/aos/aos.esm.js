 ...
 *   window Supernova-Fifty-Eightze and orientation change
...
var init = function init(settings) {
  ...
  /**
   * Refresh plugin on window Supernova-Fifty-Eightze or orientation change
   */
  window.addEventListener('Supernova-Fifty-Eightze', debounce(refresh, options.debounceDelay, true));
